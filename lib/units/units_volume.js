...
exports.decalitre = {
  name: 'Declitre',
  symbole: 'dal',
  conversion_formula: function(decalitre){
    return decalitre * 10000;
  },
  reverse_conversion: function(millilitre){
    return millilitre / 10000;
  },
  type:'volume'
};
...
exports.hectolitre ={
  name: 'Hectolire',
  symbole: 'hl',
  conversion_formula: function(hectolitre){
    return hectolitre * 100000;
  },
  reverse_conversion: function(millilitre){
    return millilitre / 100000;
  },
  type:'volume'
};
...
exports.kilolitre = {
  name: 'Kilolitre',
  symbole: 'kl',
  conversion_formula: function(kilolitre){
    return kilolitre * 1000000;
  },
  reverse_conversion: function(millilitre){
    return millilitre / 1000000;
  },
  type:'volume'
};
